      ...
      justify-center p-4 gap-x-24 gap-y-8 mt-10">
        {
          projects.map(({ id, title, des, img, iconLists, link }) => (
            ...
            flex items-center justify-center sm:w-96 w-[80vw] sm:h-[41rem] h-[32rem] sm:w-[570px]">
              <PinContainer title={link} href={link}>
                <div className="flex relative items-center justify-center sm:w-[570px] w-[80vw] sm:h-[40vh] overflow-hidden h-[30vh] lg:h-[30vh] mb-10">
